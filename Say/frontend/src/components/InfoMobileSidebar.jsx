...
const InfoMobileSidebar = () => {
  ...
  return (
    <aside className="h-full  w-full gap-y-1 flex lg:hidden flex-col transition-all duration-200 p-2 space-y-2 bg-indigo-100">
      {/* Parte superior */}
        ...
        <div className="flex flex-col gap-4">
          <div className="relative">
            <div
              ...
              style={{ backgroundColor: `${authUser.color}30` }}
            >
              <div
      ...
      {/* Parte inferior */}
      <div className="h-1/2 space-y-4 overflow-y-auto  scrollbar-transparent hover:scrollbar-default scrollbar-thin scrollbar-thumb-buttonColor scrollbar-track-transparent bg-indigo-200 flex flex-col p-6 rounded-2xl">
        <div className="flex flex-col space-y-1">
          <h2 className="text-base font-semibold text-gray-800">
...
export default InfoMobileSidebar;
