...
import MobileSkeleton from "./skeletons/MobileSkeleton";
...
const MobileSidebar = ({ closeSidebar }) => {
  ...
  if (isUsersLoading) return <MobileSkeleton />;

  return (
    <aside className="h-full lg:hidden p-2 w-full flex flex-col transition-all duration-200 bg-white">
      ...
      <div className="flex-1 my-2 overflow-y-auto space-y-3 w-full scrollbar-transparent hover:scrollbar-default scrollbar-thin scrollbar-thumb-buttonColor scrollbar-track-transparent">
